...
class AddressClientBlock extends \Magento\Framework\App\Action\Action
{
    ...
    public function getNovaposhtaAddressForm()
    {
        ...
        createBlock(\Magento\Backend\Block\Template::class)
            ->setTemplate('Perspective_NovaposhtaShipping::order/address/novaposhtaOnAdminChangeAddressClient.phtml')
            ->toHtml();
    }
}
